...
var Instrumentation = /** @class */ (function () {
    ...
    Instrumentation.start = function (config) {
        return new Promise(function (resolve, reject) {
            InstrumentationModule_1.InstrumentationModule.start(tslib_1.__assign({}, config, { interactionCaptureMode: config.interactionCaptureMode == null ? undefined : config.interactionCaptureMode.mask }), function (err) {
                if (err) {
